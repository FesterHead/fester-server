...
This file is synchronized with [AGENTS.md](../AGENTS.md). Any updates to guidelines or standards must be made to both files.
...
- Keep [AGENTS.md](../AGENTS.md) and [.github/copilot-instructions.md](copilot-instructions.md) synchronized whenever guidelines or project conventions are updated.
