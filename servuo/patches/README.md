...
| [`07-escort-destinations.patch`](07-escort-destinations.patch) | `Scripts/Mobiles/NPCs/BaseEscortable.cs` | Quests | Limits NPC escort quest destinations to mainland Britannia towns: Britain, Minoc, Trinsic, Vesper, and Skara Brae. |
